...
import Saldo from "@/assets/icones/Saldo.svg";
    ...
    return (
        <div className="bg-white mt-[120px]">
            <div className="w-full bg-[#f9f9f9] border-t border-gray-200">
                <nav
                    className="mx-auto max-w-5xl flex overflow-x-auto px-4 sm:px-6 py-2
               whitespace-nowrap gap-3 sm:gap-4
               ...
               scrollbar-none snap-x snap-mandatory"
                ...
                >
                    {tabs.map(({ step: s, label, icon: Icon }) => {
                      ...
                      px-3 sm:px-4 py-3 text-sm font-base
